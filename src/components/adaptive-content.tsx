...
function MinhFoundationContent({ content }: { content: string }) {
  const foundationEvents = [
    ...
    },
    {
      ...
      description:
        "Đảng đối mặt với nguy cơ 'giặc nội xâm': quan liêu, tham nhũng, xa dân",
    },
    {
      year: "Tương lai",
      title: "Củng cố niềm tin",
      description:
        "Học tập tư tưởng Hồ Chí Minh để đảm bảo Đảng mãi trường tồn",
    },
  ];
      ...
      <FoundationBlock
        ...
        content={
          <p>
            ...
            định sự tồn tại và phát triển của Đảng. Nhân dân chính là gốc, là
            chỗ dựa của Đảng; mất niềm tin của nhân dân đồng nghĩa với việc Đảng
            mất đi sức mạnh lãnh đạo.
          </p>
        }
